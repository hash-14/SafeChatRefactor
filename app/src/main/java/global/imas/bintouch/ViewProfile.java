...
public class ViewProfile extends AppCompatActivity {
    ...
    private DatabaseReference mUsersDatabase,mPublicProfileDatabase, mdata;
                                  ...
                                  @Override
                                   public void onDataChange(DataSnapshot dataSnapshot) {
                                      ...
                                      Tstatus.setText(x);
                                       ...
                                       Picasso.with(ViewProfile.this).load(dataSnapshot.child("image").getValue().toString()).placeholder(R.drawable.errf).into(IV);
