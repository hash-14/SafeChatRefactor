...
public class autoreply extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("View auto reply messages");
        ...
        mAutoReplyDatabase = FirebaseDatabase.getInstance().getReference().child("Auto_reply_From_Me").child(uuser_id);
        mAutoReplyDatabase.keepSynced(true);
        mAutoReplyD = FirebaseDatabase.getInstance().getReference().child("Auto_reply");
    ...
    {
        count=0;
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<AutoReplyForMe, autoreply.UsersViewHolder>(
                AutoReplyForMe.class,
                R.layout.users_single_layout_autoreplymsgs,
                autoreply.UsersViewHolder.class,
                mAutoReplyDatabase
            ...
            @Override
            protected void populateViewHolder(final autoreply.UsersViewHolder viewHolder, final AutoReplyForMe model, final int position) {
               // count++;
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        final Dialog dialog = new Dialog(autoreply.this);
                                            ...
                                            if (child.getValue(AutoReplyForMe.class).getAuto_reply_msg().toString().equals(tmsg))
                                            {
                                                if (child.getValue(AutoReplyForMe.class).getDateTime().toString().equals(tdatetime))
                                                {
                                                    ...
                                                    while(x.length()>12)
                                                    {
                                                        ...
                                                        SharedPreferences settings = PreferenceManager.getDefaultSharedPreferences(autoreply.this);
                                                        /////////////save////////////////
                                                       ...
                                                       ret = ret.replace(y,"");
                                                        ...
                                                        SharedPreferences.Editor editor = settings.edit();
                                                            editor.putString("state_autoreply_list1", ret);
                                                          editor.commit();

                                                        String uuser_id = "x123error";
                                                        SharedPreferences settings11 = PreferenceManager.getDefaultSharedPreferences(autoreply.this);
                                                        SharedPreferences.Editor editor11 = settings11.edit();
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                new CountDownTimer(500, 100) {
                                                    ...
                                                    public void onFinish() {
                                                        dialog.dismiss();
                                                        Intent startIntent = new Intent(autoreply.this, autoreply.class);
    ...
    public static class UsersViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public void setdt(String x, String y, String a , String b)
        {
            ...
            date.setText("From "+x+" to "+y);
            TextView time = mView.findViewById(R.id.textView40);
            time.setText("From "+a+" to "+b);
        }
