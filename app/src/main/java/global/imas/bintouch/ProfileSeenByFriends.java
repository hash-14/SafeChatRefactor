...
public class ProfileSeenByFriends extends AppCompatActivity {
    ...
    void attachaudio()
    {
        ...
        storageReference2nd.putFile(FilePathUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                String uuser_id = "";
                SharedPreferences settings11 = PreferenceManager.getDefaultSharedPreferences(ProfileSeenByFriends.this);
                ...
                mPublicProfileDatabase.child(uuser_id).child("music").setValue(hdf).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        if(mp!=null)
                            mp.stop();
                        Toast.makeText(ProfileSeenByFriends.this, "Uploaded!", Toast.LENGTH_LONG).show();
            ...
            uploadTask2.addOnSuccessListener(
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            if (progressBar.isShowing()) progressBar.dismiss();
                            Toast.makeText(ProfileSeenByFriends.this, "Error!", Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        B48.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final Dialog dialog = new Dialog(ProfileSeenByFriends.this);
                    ...
                    public void onClick(View view) {
                        ...
                        mPublicProfileDatabase.child(uuser_id).child("name").setValue(EE.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                Toast.makeText(ProfileSeenByFriends.this, "Updated!", Toast.LENGTH_LONG).show();
...
*/
        ...
        mPublicProfileDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.hasChild(uuser_id))
                {
                    mPublicProfileDatabase.child(uuser_id).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Picasso.with(ProfileSeenByFriends.this).load(dataSnapshot.child("image").getValue().toString()).placeholder(R.drawable.errf).into(IV);
                ...
                {
                     uuser_id = "";
                     settings11 = PreferenceManager.getDefaultSharedPreferences(ProfileSeenByFriends.this);
                     editor11 = settings11.edit();

                     select11 = settings11.getString("select", "");  /// 0 is default if variable not found
